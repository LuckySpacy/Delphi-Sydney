...
begin
 ...
 // MediaPlayer1.FileName := 'd:\Musik\save\Achim Reichel\Melancholie und Sturmflut (Bonus Tracks Edition)\Aloha Heja He.mp3';
 // MediaPlayer1.FileName := 'https://www.bachmannserver.de/sample1.m4a';
  //MediaPlayer1.FileName := 'https://www.bachmannserver.de/Aloha.m4a';
  MediaPlayer1.FileName := 'https://www.bachmannserver.de/Aloha.mp3';
  //MediaPlayer1.FileName := '/storage/9C33-6BBD/Music/Aloha.mp3';
      MediaPlayer1.Play;
...
begin
  ...
  ListBox2.Items.Add('https://www.bachmannserver.de/sample1.m4a');
