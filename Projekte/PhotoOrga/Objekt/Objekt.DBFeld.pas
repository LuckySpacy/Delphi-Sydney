...
procedure TDBFeld.LoadFromStream(aStream: TMemoryStream);
begin
  aStream.Clear;
  fMemoryStream.Position := 0;
  aStream.Position := 0;
  aStream.LoadFromStream(fMemoryStream);
end;

procedure TDBFeld.SaveToStream(aStream: TMemoryStream);
begin
  fMemoryStream.Clear;
  fMemoryStream.Position := 0;
  aStream.Position := 0;
  fMemoryStream.LoadFromStream(aStream);
end;
