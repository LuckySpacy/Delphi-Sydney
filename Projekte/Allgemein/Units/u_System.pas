...
uses
  Windows, SysUtils, Classes, FileCtrl, Dialogs, ShellApi, Forms, ClipBrd, c_AllgTypes,
  System.UITypes;
  ...
  procedure DeleteOldFiles(aPath, aFilename: string; aAnzahl: Integer);
...
begin
  FileList := TStringList.Create;
  try
    GetAllFiles(aPath, FileList, true, false);
  finally
    FreeAndNil(FileList);
  end;
end;
