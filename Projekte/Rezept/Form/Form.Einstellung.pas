...
uses
  ...
  nfsButton, Form.IniMySql, Form.IniDatenbankAllgemein;
...
type
  ...
  private
    ...
    fFormIniMySql: Tfrm_IniMySql;
    fFormIniDatenbankAllgemein: Tfrm_IniDatenbankAllgemein;
    fFormList: TList;
    procedure LoadTree;
...
begin  //
  ...
  fFormIniMySql := nil;
  fFormIniDatenbankAllgemein := nil;
...
begin  //
  ...
  if fFormIniMySql <> nil then
    FreeAndNil(fFormIniMySql);
  if fFormIniDatenbankAllgemein <> nil then
    FreeAndNil(fFormIniDatenbankAllgemein);
...
begin
  ...
  Form := nil;
  case aIndex of
    0: Form := Tfrm_IniDatenbankAllgemein.Create(Self);
    1: Form := Tfrm_IniFirebird.Create(Self);
    2: Form := Tfrm_IniMySql.Create(Self);
  end;
