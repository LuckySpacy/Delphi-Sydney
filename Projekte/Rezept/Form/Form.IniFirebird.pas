...
begin //
  edt_Host.Text          := Rezept.Ini.Firebird.Host;
  edt_Datenbankpfad.Text := Rezept.Ini.Firebird.Datenbankpfad;
  edt_Datenbankname.Text := Rezept.Ini.Firebird.Datenbankname;
  edt_Username.Text      := Rezept.Ini.Firebird.Username;
  edt_Passwort.Text      := Rezept.Ini.Firebird.Passwort;
end;
...
begin
  Rezept.Ini.Firebird.Host          := edt_Host.Text;
  Rezept.Ini.Firebird.Datenbankpfad := edt_Datenbankpfad.Text;
  Rezept.Ini.Firebird.Datenbankname := edt_Datenbankname.Text;
  Rezept.Ini.Firebird.Username      := edt_Username.Text;
  Rezept.Ini.Firebird.Passwort      := edt_Passwort.Text;
end;
...
begin
  ...
  if dm.IB_Rezept.connected then
