...
begin
    Result := Self.Parent.FramesList.IndexOf(Self);
end;
...
begin
    for i := FrameCount - 1 downto 0 do begin
        if IsSameFrameID(FramesList[i].ID, 'APIC') then begin
            DeleteFrame(i);
        end;
    end;
end;
...
begin
    try
        ...
        if Root.MajorVersion = 2 then begin
            FrameSize := 0;
            Stream.Read2(FrameSize, 3);
            FramesList[FrameIndex].Size := ReverseBytes32(FrameSize SHL 8);
            if FramesList[FrameIndex].Size > Root.Size then begin
                Root.FError := True;
            end
            else if FramesList[FrameIndex].Size > 0 then begin
                FramesList[FrameIndex].Unsynchronised := Root.Unsynchronised;

                if Root.ParseCoverArts then begin
                    FramesList[FrameIndex].Stream.CopyFrom(Stream, FramesList[FrameIndex].Size);
                end else begin
                    if IsSameFrameID(FramesList[FrameIndex].ID, 'PIC') then begin
                        Stream.Seek(FramesList[FrameIndex].Size, soCurrent);
                    end else begin
                        FramesList[FrameIndex].Stream.CopyFrom(Stream, FramesList[FrameIndex].Size);
                    end;
                end;
        ...
        if Root.MajorVersion = 3 then begin
            ...
            FramesList[FrameIndex].Size := ReverseBytes32(FrameSize);
            Stream.Read2(FrameFlags, 2);
            FramesList[FrameIndex].Flags := ReverseBytes16(FrameFlags);
            if FramesList[FrameIndex].Size > Root.Size then begin
                Root.FError := True;
            end
            else if FramesList[FrameIndex].Size > 0 then begin
                FramesList[FrameIndex].DecodeFlags3;
                FramesList[FrameIndex].Unsynchronised := Root.Unsynchronised;
                if FramesList[FrameIndex].Compressed then begin
                    Stream.Read2(DataLengthIndicatorValueCoded, 4);
                    UnSyncSafe(DataLengthIndicatorValueCoded, 4, FramesList[FrameIndex].DataLengthIndicatorValue);
                    FramesList[FrameIndex].DataLengthIndicator := True;
                    FramesList[FrameIndex].Size := FramesList[FrameIndex].Size - 4;
                end;
                if FramesList[FrameIndex].Encrypted then begin
                    Stream.Read2(FramesList[FrameIndex].EncryptionMethod, 1);
                    FramesList[FrameIndex].Size := FramesList[FrameIndex].Size - 1;
                end;
                if FramesList[FrameIndex].GroupingIdentity then begin
                    Stream.Read2(FramesList[FrameIndex].GroupIdentifier, 1);
                    FramesList[FrameIndex].Size := FramesList[FrameIndex].Size - 1;
                end;
                if Root.ParseCoverArts then begin
                    FramesList[FrameIndex].Stream.CopyFrom(Stream, FramesList[FrameIndex].Size);
                end else begin
                    if IsSameFrameID(FramesList[FrameIndex].ID, 'APIC') then begin
                        Stream.Seek(FramesList[FrameIndex].Size, soCurrent);
                    end else begin
                        FramesList[FrameIndex].Stream.CopyFrom(Stream, FramesList[FrameIndex].Size);
                    end;
        ...
        if Root.MajorVersion > 3 then begin
            Stream.Read2(FrameSize, 4);
            UnSyncSafe(FrameSize, 4, FramesList[FrameIndex].Size);
            Stream.Read2(FrameFlags, 2);
            FramesList[FrameIndex].Flags := ReverseBytes16(FrameFlags);
            if FramesList[FrameIndex].Size > Root.Size then begin
                Root.FError := True;
                ...
                FramesList[FrameIndex].DecodeFlags4;
                if FramesList[FrameIndex].GroupingIdentity then begin
                    Stream.Read2(FramesList[FrameIndex].GroupIdentifier, 1);
                    FramesList[FrameIndex].Size := FramesList[FrameIndex].Size - 1;
                end;
                ...
                if FramesList[FrameIndex].DataLengthIndicator then begin
                    Stream.Read2(DataLengthIndicatorValueCoded, 4);
                    UnSyncSafe(DataLengthIndicatorValueCoded, 4, FramesList[FrameIndex].DataLengthIndicatorValue);
                    FramesList[FrameIndex].Size := FramesList[FrameIndex].Size - 4;
                end;
        ...
        if FramesList[FrameIndex] is TID3v2FrameCHAP then begin
            (FramesList[FrameIndex] as TID3v2FrameCHAP).Parse;
        end;
        if FramesList[FrameIndex] is TID3v2FrameCTOC then begin
            (FramesList[FrameIndex] as TID3v2FrameCTOC).Parse;
        end;
    except
        //*
    end;
...
begin
    if FramesList.Count = FramesList.Capacity then begin
        FramesList.Capacity := FramesList.Capacity + ID3V2LIBRARY_FRAMES_GROWBY;
    end;
    ...
    NewFrame.ID := FrameID;
    Result := FramesList.Add(NewFrame);
end;
...
begin
    Self.Clear;
    for i := 0 to Source.FramesList.Count - 1 do begin
        NewFrameIndex := Self.AddFrame(Source.FramesList[i].ID);
        Self.FramesList[NewFrameIndex].Assign(Source.FramesList[i]);
    end;
end;
...
begin
    ...
    FramesList[FrameIndex].Free;
    FramesList.Delete(FrameIndex);
    Result := True;
end;
...
begin
    ...
    try
        if FramesList[FrameIndex].Stream.Size = 0 then begin
            Exit;
        end;
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);

        PictureStream := TMemoryStream.Create;

        try
            //* Get encoding
            Encoding := FramesList[FrameIndex].Stream.ReadEncoding;

            //* Get MIME type
            StrMIMEType := '';
            for i := 0 to 2 do begin
                FramesList[FrameIndex].Stream.Read2(DataByte, 1);
                if DataByte <> 0 then begin
            ...
            //* Get description
            Description := FramesList[FrameIndex].Stream.ReadText(Encoding);

            //* Get binary picture data
            PictureStream.Seek(0, soBeginning);
            try
                PictureStream.CopyFrom(FramesList[FrameIndex].Stream, FramesList[FrameIndex].Stream.Size - FramesList[FrameIndex].Stream.Position);
                PictureStream.Seek(0, soBeginning);
            except
...
begin
    Result := False;
    V2FrameID := Char(FramesList[FrameIndex].ID[0]) + Char(FramesList[FrameIndex].ID[1]) + Char(FramesList[FrameIndex].ID[2]);
    if V2FrameID = 'PIC' then begin
        ConvertString2FrameID('APIC', FramesList[FrameIndex].ID);
        Convertv2PICtoAPIC(FrameIndex);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'BUF' then begin
        ConvertString2FrameID('RBUF', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'CNT' then begin
        ConvertString2FrameID('PCNT', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'COM' then begin
        ConvertString2FrameID('COMM', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'CRA' then begin
        ConvertString2FrameID('AENC', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'ETC' then begin
        ConvertString2FrameID('ETCO', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'EQU' then begin
        ConvertString2FrameID('EQUA', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'GEO' then begin
        ConvertString2FrameID('GEOB', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'GP1' then begin
        ConvertString2FrameID('GRP1', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'IPL' then begin
        ConvertString2FrameID('TIPL', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'LNK' then begin
        ConvertString2FrameID('LINK', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'MCI' then begin
        ConvertString2FrameID('MCDI', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'MLL' then begin
        ConvertString2FrameID('MLLT', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'MVI' then begin
        ConvertString2FrameID('MVIN', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'MVN' then begin
        ConvertString2FrameID('MVNM', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'POP' then begin
        ConvertString2FrameID('POPM', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'REV' then begin
        ConvertString2FrameID('RVRB', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'RVA' then begin
        ConvertString2FrameID('RVAD', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'SLT' then begin
        ConvertString2FrameID('SYLT', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'STC' then begin
        ConvertString2FrameID('SYTC', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TAL' then begin
        ConvertString2FrameID('TALB', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TBP' then begin
        ConvertString2FrameID('TBPM', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TCM' then begin
        ConvertString2FrameID('TCOM', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TCO' then begin
        ConvertString2FrameID('TCON', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TCP' then begin
        ConvertString2FrameID('TCMP', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TCR' then begin
        ConvertString2FrameID('TCOP', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TDA' then begin
        ConvertString2FrameID('TDAT', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TDY' then begin
        ConvertString2FrameID('TDLY', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TEN' then begin
        ConvertString2FrameID('TENC', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TFT' then begin
        ConvertString2FrameID('TFLT', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TIM' then begin
        ConvertString2FrameID('TIME', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TKE' then begin
        ConvertString2FrameID('TKEY', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TLA' then begin
        ConvertString2FrameID('TLAN', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TLE' then begin
        ConvertString2FrameID('TLEN', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TMT' then begin
        ConvertString2FrameID('TMED', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TOA' then begin
        ConvertString2FrameID('TOPE', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TOF' then begin
        ConvertString2FrameID('TOFN', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TOL' then begin
        ConvertString2FrameID('TOLY', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TOR' then begin
        ConvertString2FrameID('TORY', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TOT' then begin
        ConvertString2FrameID('TOAL', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TP1' then begin
        ConvertString2FrameID('TPE1', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TP2' then begin
        ConvertString2FrameID('TPE2', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TP3' then begin
        ConvertString2FrameID('TPE3', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TP4' then begin
        ConvertString2FrameID('TPE4', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TPA' then begin
        ConvertString2FrameID('TPOS', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TPB' then begin
        ConvertString2FrameID('TPUB', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TRC' then begin
        ConvertString2FrameID('TSRC', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TRD' then begin
        ConvertString2FrameID('TRDA', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TRK' then begin
        ConvertString2FrameID('TRCK', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TRN' then begin
        ConvertString2FrameID('TRSN', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TRO' then begin
        ConvertString2FrameID('TRSO', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TS2' then begin
        ConvertString2FrameID('TSO2', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TSA' then begin
        ConvertString2FrameID('TSOA', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TSC' then begin
        ConvertString2FrameID('TSOC', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TSI' then begin
        ConvertString2FrameID('TSIZ', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TSP' then begin
        ConvertString2FrameID('TSOP', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TSS' then begin
        ConvertString2FrameID('TSSE', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TST' then begin
        ConvertString2FrameID('TSOT', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TT1' then begin
        ConvertString2FrameID('TIT1', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TT2' then begin
        ConvertString2FrameID('TIT2', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TT3' then begin
        ConvertString2FrameID('TIT3', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TXT' then begin
        ConvertString2FrameID('TEXT', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TXX' then begin
        ConvertString2FrameID('TXXX', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'TYE' then begin
        ConvertString2FrameID('TYER', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'UFI' then begin
        ConvertString2FrameID('UFID', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'ULT' then begin
        ConvertString2FrameID('USLT', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'WAF' then begin
        ConvertString2FrameID('WOAF', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'WAR' then begin
        ConvertString2FrameID('WOAR', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'WAS' then begin
        ConvertString2FrameID('WOAS', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'WCM' then begin
        ConvertString2FrameID('WCOM', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'WCP' then begin
        ConvertString2FrameID('WCOP', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'WPB' then begin
        ConvertString2FrameID('WPUB', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
    if V2FrameID = 'WXX' then begin
        ConvertString2FrameID('WXXX', FramesList[FrameIndex].ID);
        Result := True;
        Exit;
    end;
end;
...
begin
    ...
    for i := 0 to FrameCount - 1 do begin
        if IsSameFrameID(FrameID, FramesList[i].ID) then begin
            Result := i;
            Break;
        end;
    end;
...
begin
    ...
    for i := 0 to FrameCount - 1 do begin
        if IsSameFrameID(TempFrameID, FramesList[i].ID) then begin
            Result := i;
            Break;
        end;
    end;
...
begin
    ...
    try
        ...
        //* Get the content
        while True do begin
            Result := Result + FramesList[FrameIndex].Stream.ReadText(Encoding, @BigEndian, @NilFound);
            if (NOT NilFound)
            OR (FramesList[FrameIndex].Stream.Position >= FramesList[FrameIndex].Stream.Size)
            then begin
                Break;
            end;
            Result := Result + #13#10;
...
begin
    ...
    try
        FramesList[FrameIndex].Stream.Clear;
        Data := $01;
        FramesList[FrameIndex].Stream.Write(Data, 1);
        Data := $FF;
        FramesList[FrameIndex].Stream.Write(Data, 1);
        Data := $FE;
        FramesList[FrameIndex].Stream.Write(Data, 1);
        FramesList[FrameIndex].Stream.Write(PWideChar(Text)^, (Length(Text) + 1) * 2);
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
        Result := True;
    except
        //*
...
begin
    ...
    try
        ...
        for i := 0 to List.Count - 1 do begin
            ...
            FramesList[FrameIndex].Stream.Write(Bytes[0], Length(Bytes));
            Data := $0;
            FramesList[FrameIndex].Stream.Write(Data, 1);
        end;
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
...
begin
    ...
    try
        ...
        Encoding := FramesList[FrameIndex].Stream.ReadEncoding;
        //* Get language ID
        FramesList[FrameIndex].Stream.Read2(LanguageID[0], 3);
        //* Get description
        Description := FramesList[FrameIndex].Stream.ReadText(Encoding, @BigEndian);
        //* Get the content
        Result := FramesList[FrameIndex].Stream.ReadText(Encoding, @BigEndian);
    except
        //*
    end;
end;
...
begin
    ...
    try
        ...
        //* Encoding (unicode)
        DataByte := $01;
        FramesList[FrameIndex].Stream.Write(DataByte, 1);
        //* PricePaid
        PricePaidBytes := TEncoding.ANSI.GetBytes(PricePaid);
        FramesList[FrameIndex].Stream.Write(PricePaidBytes[0], Length(PricePaidBytes));
        DataByte := $00;
        FramesList[FrameIndex].Stream.Write(DataByte, 1);
        //* DateOfPurchase
        DateOfPurchaseBytes := TEncoding.ANSI.GetBytes(DateOfPurchase);
        FramesList[FrameIndex].Stream.Write(DateOfPurchaseBytes[0], Length(DateOfPurchaseBytes));
        //* Seller
        SellerBytes := TEncoding.Unicode.GetBytes(Seller);
        FramesList[FrameIndex].Stream.Write(SellerBytes[0], Length(SellerBytes));
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
        Result := True;
    except
        //*
...
begin
    ...
    try
        ...
        FramesList[FrameIndex].Stream.Write(MIMETypeBytes[0], Length(MIMETypeBytes));
        DataByte := $00;
        FramesList[FrameIndex].Stream.Write(DataByte, 1);
        //* Filename
        FilenameBytes := TEncoding.Unicode.GetBytes(EncapsulatedObjectFilename);
        FramesList[FrameIndex].Stream.Write(FilenameBytes[0], Length(FilenameBytes));
        DataWord := $0000;
        FramesList[FrameIndex].Stream.Write(DataWord, 2);
        //* ContentDescription
        ContentDescriptionBytes := TEncoding.Unicode.GetBytes(ContentDescription);
        FramesList[FrameIndex].Stream.Write(ContentDescriptionBytes[0], Length(ContentDescriptionBytes));
        DataWord := $0000;
        FramesList[FrameIndex].Stream.Write(DataWord, 2);
        //* EncapsulatedObject
        FramesList[FrameIndex].Stream.Write(EncapsulatedObject[0], Length(EncapsulatedObject));
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
        Result := True;
    except
        //*
...
begin
    ...
    try
        ...
        FramesList[FrameIndex].Stream.Write(Data, 1);
        //* Set the language
        FramesList[FrameIndex].Stream.Write(LanguageID[0], 3);
        //* Set the description
...
begin
    ...
    try
        ...
        Data := $FE;
        FramesList[FrameIndex].Stream.Write(Data, 1);
        FramesList[FrameIndex].Stream.Write(PWideChar(Description)^, (Length(Description) + 1) * 2);
        //* Write the content with BOM
        Data := $FF;
        FramesList[FrameIndex].Stream.Write(Data, 1);
        Data := $FE;
        FramesList[FrameIndex].Stream.Write(Data, 1);
        FramesList[FrameIndex].Stream.Write(PWideChar(Content)^, (Length(Content) + 1) * 2);
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
        Result := True;
    except
        //*
...
begin
    ...
    try
        ...
        Encoding := FramesList[FrameIndex].Stream.ReadEncoding;
        //* Get MIME type
        MIMEType := FramesList[FrameIndex].Stream.ReadText;
        //* Get picture type
        FramesList[FrameIndex].Stream.Read2(DataByte, 1);
        CoverType := DataByte;
        //* Get description
...
begin
    ...
    try
        ...
        if Bytes <> nil then begin
            PictureDataSize := FramesList[FrameIndex].Stream.Size - FramesList[FrameIndex].Stream.Position;
            if PictureDataSize > 0 then begin
                SetLength(Bytes^, PictureDataSize);
                FramesList[FrameIndex].Stream.Read2(Bytes^[0], PictureDataSize);
            end;
        end;
        Result := True;
    except
...
begin
    ...
    try
        ...
        Encoding := FramesList[FrameIndex].Stream.ReadEncoding;
        //* Get MIME type
        MIMEType := Pointer(NativeUInt(FramesList[FrameIndex].Stream.Memory) + UInt64(FramesList[FrameIndex].Stream.Position));
        repeat
            FramesList[FrameIndex].Stream.Read2(DataByte, 1);
        until (DataByte = 0)
        OR (FramesList[FrameIndex].Stream.Position >= FramesList[FrameIndex].Stream.Size);
        ...
        case Encoding of
            //* ISO-8859-1
            0: begin
                Description := Pointer(NativeUInt(FramesList[FrameIndex].Stream.Memory) + UInt64(FramesList[FrameIndex].Stream.Position));
                repeat
                    FramesList[FrameIndex].Stream.Read2(DataByte, 1);
                until (DataByte = 0)
                OR (FramesList[FrameIndex].Stream.Position >= FramesList[FrameIndex].Stream.Size);
            ...
            //* UTF-16
            1: begin
                FramesList[FrameIndex].Stream.ReadBOM;
                Description := Pointer(NativeUInt(FramesList[FrameIndex].Stream.Memory) + UInt64(FramesList[FrameIndex].Stream.Position));
                repeat
                    FramesList[FrameIndex].Stream.Read2(DataWord, 2);
                until (DataWord = 0)
                OR (FramesList[FrameIndex].Stream.Position >= FramesList[FrameIndex].Stream.Size);
            end;
            //* UTF-16BE
        ...
        //* Get binary picture data
        Data := Pointer(NativeUInt(FramesList[FrameIndex].Stream.Memory) + UInt64(FramesList[FrameIndex].Stream.Position));
        DataSize := FramesList[FrameIndex].Stream.Size - FramesList[FrameIndex].Stream.Position;
        Result := True;
    except
        //*
    end;
...
begin
    ...
    try
        ...
        MIMEType := FramesList[FrameIndex].Stream.ReadText;
        //* Get filename
        EncapsulatedObjectFilename := FramesList[FrameIndex].Stream.ReadText(Encoding, @BigEndian);
        //* Get content description
        ContentDescription := FramesList[FrameIndex].Stream.ReadText(Encoding, @BigEndian);
        //* Get the content
        DataSize := FramesList[FrameIndex].Stream.Size - FramesList[FrameIndex].Stream.Position;
        if DataSize > 0 then begin
            SetLength(Result, DataSize);
            FramesList[FrameIndex].Stream.Read2(Result[0], DataSize);
        end;
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
    except
        //*
...
begin
    ...
    try
        ...
        //* Set picture data
        PictureStream.Seek(0, soBeginning);
        FramesList[FrameIndex].Stream.CopyFrom(PictureStream, PictureStream.Size);
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
        Result := True;
    except
        //*
...
begin
    ...
    try
        ...
        FramesList[FrameIndex].Stream.Read2(LanguageID[0], 3);
        //* Get the content
        Result := FramesList[FrameIndex].Stream.ReadText(Encoding);
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
    except
        //*
    end;
...
begin
    ...
    try
        ...
        FramesList[FrameIndex].Stream.Seek(5, soBeginning);
        //* Get the content
        Result := FramesList[FrameIndex].Stream.ReadText(3);
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
    except
        //*
    end;
...
begin
    ...
    try
        ...
        FramesList[FrameIndex].Stream.Seek(4, soBeginning);
        //* Get the content
        Result := FramesList[FrameIndex].Stream.ReadText(0);
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
    except
        //*
    end;
...
begin
    ...
    try
        ...
        //* 'iXML'
        FramesList[FrameIndex].Stream.Write(iXMLID[0], 4);
        DataByte := $00;
        FramesList[FrameIndex].Stream.Write(DataByte, 1);
        //* The content
        XMLBytes := TEncoding.UTF8.GetBytes(XMLText);
        FramesList[FrameIndex].Stream.Write(XMLBytes[0], Length(XMLBytes));
        DataByte := $00;
        FramesList[FrameIndex].Stream.Write(DataByte, 1);
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
        Result := True;
...
begin
    ...
    try
        ...
        //* 'XMP'
        FramesList[FrameIndex].Stream.Write(XMPID[0], 3);
        DataByte := $00;
        FramesList[FrameIndex].Stream.Write(DataByte, 1);
        //* The content
        XMPBytes := TEncoding.ANSI.GetBytes(XMPText);
        FramesList[FrameIndex].Stream.Write(XMPBytes[0], Length(XMPBytes));
        //* $00$00
        DataByte := $00;
        FramesList[FrameIndex].Stream.Write(DataByte, 1);
        FramesList[FrameIndex].Stream.Write(DataByte, 1);
...
begin
    ...
    for i := 0 to FrameCount - 1 do begin
        if IsSameFrameID(FramesList[i].ID, FrameID) then begin
...
begin
    ...
    try
        ...
        Description := FramesList[FrameIndex].Stream.ReadText(Encoding);
        //* Get the URL
        Result := FramesList[FrameIndex].Stream.ReadText;
    except
        //*
    end;
end;
...
begin
    ...
    case Root.MajorVersion of
        2: begin
            //* Check frame sizes
            if FramesList[FrameIndex].Stream.Size > 16777215 {2^24} then begin
                Result := Result + [id3v2feContentToLarge];
            end;
            if FramesList[FrameIndex].Size > 16777215 {2^24} then begin
    ...
    //* v3 and v4
            ...
            if NOT ValidID3v2FrameID(FramesList[FrameIndex].ID) then begin
            ...
            case Root.MajorVersion of
                ...
                3: begin
                    if (FramesList[FrameIndex].Flags AND $1F1F) > 0 then begin
                        Result := Result + [id3v2feInvalidFlags];
                    end;
                end;
                4: begin
                    if (FramesList[FrameIndex].Flags AND $8FB0) > 0 then begin
                        Result := Result + [id3v2feInvalidFlags];
                    end;
                end;
            end;
            //* Check frame sizes
            if FramesList[FrameIndex].Stream.Size > 268435455 {2^28} then begin
                Result := Result + [id3v2feContentToLarge];
            end;
            if FramesList[FrameIndex].Size > 268435455 {2^28} then begin
                Result := Result + [id3v2feSizeSpecifiedToLarge];
            end;
        end;
    end;
    //* Check text frame encoding validity
    if FramesList[FrameIndex].ID[0] = Ord('T') then begin
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
        FramesList[FrameIndex].Stream.Read2(Encoding, 1);
...
begin
    ...
    try
        ...
        FramesList[FrameIndex].Stream.Write(TermsOfUseBytes[0], Length(TermsOfUseBytes));
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
        Result := True;
    except
        //*
...
begin
    TotalFramesSize := 0;
    for i := 0 to FrameCount - 1 do begin
        if ValidID3v2FrameID(FramesList[i].ID) then begin
            TotalFramesSize := TotalFramesSize + FramesList[i].Stream.Size;
        end;
    end;
...
begin
    Result := 0;
    if Root.MajorVersion = 2 then begin
        Result := FramesList[FrameIndex].Stream.Size;
    end;
    if Root.MajorVersion = 3 then begin
        Result := FramesList[FrameIndex].Stream.Size;
        if FramesList[FrameIndex].Compressed
        OR FramesList[FrameIndex].DataLengthIndicator
        then begin
            Result := Result + 4;
        end;
        if FramesList[FrameIndex].Encrypted then begin
...
begin
    try
        for i := 0 to FrameCount - 1 do begin
            if (NOT ValidID3v2FrameID(FramesList[i].ID))
            OR (FramesList[i].Stream.Size = 0)
            then begin
                Continue;
            end;
            Stream.Write(FramesList[i].ID, 4);
            UnCodedSize := FullFrameSize(i);
            if Root.MajorVersion = 3 then begin
                CodedSize := ReverseBytes32(UnCodedSize);
                Stream.Write(CodedSize, 4);
                FramesList[i].EncodeFlags3;
                Stream.Write(FramesList[i].Flags, 2);
                SyncSafe(FramesList[i].DataLengthIndicatorValue, DataLengthIndicatorValueSyncSafe, 4);
                if FramesList[i].Compressed
                OR FramesList[i].DataLengthIndicator
                then begin
                    Stream.Write(DataLengthIndicatorValueSyncSafe, 4);
                end;
                if FramesList[i].Encrypted then begin
                    Stream.Write(FramesList[i].EncryptionMethod, 1);
                end;
                if FramesList[i].GroupingIdentity then begin
                    Stream.Write(FramesList[i].GroupIdentifier, 1);
                end;
            end;
            if Root.MajorVersion = 4 then begin
                ...
                Stream.Write(CodedSize, 4);
                FramesList[i].EncodeFlags4;
                ReversedFlags := ReverseBytes16(FramesList[i].Flags);
                ...
                SyncSafe(FramesList[i].DataLengthIndicatorValue, DataLengthIndicatorValueSyncSafe, 4);
                if FramesList[i].DataLengthIndicator then begin
                    Stream.Write(DataLengthIndicatorValueSyncSafe, 4);
                end;
            end;
            Stream.CopyFrom(FramesList[i].Stream, 0);
        end;
        Result := ID3V2LIBRARY_SUCCESS;
    except
        Result := ID3V2LIBRARY_ERROR_WRITING_FILE;
...
var
    i: Integer;
begin
    for i := 0 to FramesList.Count - 1 do begin
        FramesList[i].AlreadyParsed := False;
    end;
end;
...
begin
    ...
    try
        SEBR := 0;
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
        FramesList[FrameIndex].Stream.Read2(SEBR, 10);
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
        Result := SEBR;
    except
        //*
...
begin
    ...
    FramesList[FrameIndex].Stream.Seek(10, soBeginning);
    try
        SEBR := '';
        Data := 0;
        repeat
            FramesList[FrameIndex].Stream.Read2(Data, 1);
            if Data <> 0 then begin
                SEBR := SEBR + Char(Data);
            end;
        until FramesList[FrameIndex].Stream.Position >= FramesList[FrameIndex].Stream.Size;
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
        Result := SEBR;
    except
        //*
...
begin
    ...
    try
        ...
        FramesList[FrameIndex].Stream.Write(SEBR, 10);
        {$ENDIF}
...
begin
    ...
    FramesList[FrameIndex].Stream.Clear;
    try
        FramesList[FrameIndex].Stream.Write(BitRateValue, 10);
...
begin
    ...
    Version := 1;
    Channels := 2;
    if FramesList[FrameIndex].Unsynchronised then begin
        FramesList[FrameIndex].RemoveUnsynchronisation;
    end;
    if FramesList[FrameIndex].Compressed
    ...
    then begin
        ...
        //* Compression not supported
        {$ELSE}
        FramesList[FrameIndex].DeCompress;
        {$ENDIF}
    end;
    FramesList[FrameIndex].Stream.Seek(0, soBeginning);
    try
        FramesList[FrameIndex].Stream.Read2(ID, 4);
        if ID = ID3V2LIBRARY_SESC_ID then begin
            FramesList[FrameIndex].Stream.Read2(DataVersion, 1);
            FramesList[FrameIndex].Stream.Read2(SESCHeaderSize, 4);
            Version := DataVersion;
            if DataVersion = ID3V2LIBRARY_SESC_VERSION2 then begin
                if SESCHeaderSize >= 4 then begin
                    FramesList[FrameIndex].Stream.Read2(ReportedChannels, 4);
                    SeekPosition := SESCHeaderSize - 4;
                    FramesList[FrameIndex].Stream.Seek(SeekPosition, soCurrent);
                end;
            end;
        end else begin
            FramesList[FrameIndex].Stream.Seek(-4, soCurrent);
        end;
        SetLength(Result, FramesList[FrameIndex].Stream.Size - FramesList[FrameIndex].Stream.Position);
        FramesList[FrameIndex].Stream.Read2(Pointer(Result)^, FramesList[FrameIndex].Stream.Size - FramesList[FrameIndex].Stream.Position);
    except
        //*
    end;
    FramesList[FrameIndex].Stream.Seek(0, soBeginning);
...
begin
    ...
    try
        ...
        FramesList[FrameIndex].Stream.Write(SESCID, 4);
        DataVersion := ID3V2LIBRARY_SESC_VERSION2;
        FramesList[FrameIndex].Stream.Write(DataVersion, 1);
        SESCHeaderSize := 4;
        FramesList[FrameIndex].Stream.Write(SESCHeaderSize, 4);
        FramesList[FrameIndex].Stream.Write(Channels, 4);
        FramesList[FrameIndex].Stream.Write(Pointer(SESC)^, Length(SESC));
        {$IFDEF FPC}
        //* Compression not supported
        {$ELSE}
        FramesList[FrameIndex].Compress;
        {$ENDIF}
        Result := True;
    except
        //*
...
begin
    ...
    try
        FramesList[FrameIndex].Stream.Clear;
        FramesList[FrameIndex].Stream.Write(TitleColor, 4);
        FramesList[FrameIndex].Stream.Write(TextColor, 4);
        Result := True;
    except
        //*
    end;
...
begin
    ...
    try
        ...
        FramesList[FrameIndex].Stream.Write(OwnerIdentifierBytes[0], Length(OwnerIdentifierBytes));
        DataByte := $00;
        FramesList[FrameIndex].Stream.Write(DataByte, 1);
        //* Preview
        ...
        FramesList[FrameIndex].Stream.Write(DataWord, 2);
        //* EncryptionInfo
        FramesList[FrameIndex].Stream.Write(EncryptionInfo[0], Length(EncryptionInfo));
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
        Result := True;
    except
        //*
...
begin
    for i := 0 to FramesList.Count - 1 do begin
        ...
        if FramesList[i] is TID3v2FrameCHAP then begin
            (FramesList[i] as TID3v2FrameCHAP).SubFrames.SetAllFrameDataStreams;
            (FramesList[i] as TID3v2FrameCHAP).SetData;

        end;
        if FramesList[i] is TID3v2FrameCTOC then begin
            (FramesList[i] as TID3v2FrameCTOC).SubFrames.SetAllFrameDataStreams;
            (FramesList[i] as TID3v2FrameCTOC).SetData;
        end;
    end;
end;
...
begin
    ...
    try
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
        FramesList[FrameIndex].Stream.Read2(TitleColor, 4);
        FramesList[FrameIndex].Stream.Read2(TextColor, 4);
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
        Result := True;
    except
        //*
...
begin
    ...
    try
        try
            Value := 0;
            FramesList[FrameIndex].Stream.Seek(0, soBeginning);
            for i := 0 to FramesList[FrameIndex].Stream.Size - 1 do begin
                Value := Value SHL 8;
                FramesList[FrameIndex].Stream.Read2(DataByte, 1);
...
begin
    ...
    try
        if MajorVersion = 3 then begin
            if Unsynchronised then begin
                for i := 0 to FramesList.Count - 1 do begin
                    FramesList[i].RemoveUnsynchronisation;
                end;
                Unsynchronised := False;
            end;
        end;
        if MajorVersion = 4 then begin
            for i := 0 to FramesList.Count - 1 do begin
                if FramesList[i].Unsynchronised then begin
                    FramesList[i].RemoveUnsynchronisation;
                end;
            end;
            Unsynchronised := False;
...
begin
    ...
    try
        if MajorVersion = 3 then begin
            for i := 0 to FramesList.Count - 1 do begin
                FramesList[i].ApplyUnsynchronisation;
            end;
            Unsynchronised := True;
        end;
        if MajorVersion = 4 then begin
            for i := 0 to FramesList.Count - 1 do begin
                if NOT FramesList[i].Unsynchronised then begin
                    FramesList[i].ApplyUnsynchronisation;
                end;
            end;
            Unsynchronised := True;
...
begin
    ...
    try
        for i := 0 to FramesList.Count - 1 do begin
            if FramesList[i].Compressed then begin
                {$IFDEF FPC}
                //* Compression not supported
                {$ELSE}
                FramesList[i].DeCompress;
                {$ENDIF}
            end;
        end;
        Result := True;
...
begin
    Result := - 1;
    for i := 0 to FrameCount - 1 do begin
        if IsSameFrameID(FramesList[i].ID, 'CHAP') then begin
            if FramesList[i] is TID3v2FrameCHAP then begin
                if (FramesList[i] as TID3v2FrameCHAP).ElementID = ChapterElementID then begin
                    Result := i;
                    Break;
                end;
            end;
...
begin
    ...
    AnsiStringToPAnsiChar(FrameID, ID);
    for i := 0 to FrameCount - 1 do begin
        if IsSameFrameID(ID, FramesList[i].ID) then begin
...
begin
    ...
    try
        ...
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
        //* Get e-mail
        Email := FramesList[FrameIndex].Stream.ReadText;
        //* Get rating
        FramesList[FrameIndex].Stream.Read2(DataByte, 1);
        Rating := DataByte;
        //* Get playcount
        try
            while FramesList[FrameIndex].Stream.Position < FramesList[FrameIndex].Stream.Size do begin
...
begin
    ...
    try
        ...
        FramesList[FrameIndex].Stream.Write(Data, 1);
        //* Write rating
        FramesList[FrameIndex].Stream.Write(Rating, 1);
        //* Write playcount
...
begin
    ...
    try
        FramesList[Index].Stream.Clear;
        Data := $01;
        FramesList[Index].Stream.Write(Data, 1);
        Data := $FF;
        FramesList[Index].Stream.Write(Data, 1);
        Data := $FE;
        FramesList[Index].Stream.Write(Data, 1);
        FramesList[Index].Stream.Write(PWideChar(Description)^, (Length(Description) + 1) * 2);
        Data := $FF;
        FramesList[Index].Stream.Write(Data, 1);
        Data := $FE;
        FramesList[Index].Stream.Write(Data, 1);
        FramesList[Index].Stream.Write(PWideChar(Text)^, (Length(Text) + 1) * 2);
        FramesList[Index].Stream.Seek(0, soBeginning);
        Result := True;
    except
        //*
    end;
...
begin
    ...
    try
        ...
        for i := 0 to List.Count - 1 do begin
            ...
            FramesList[Index].Stream.Write(PWideChar(Name)^, (Length(Name) + 1) * 2);
            FramesList[Index].Stream.Write(PWideChar(Value)^, (Length(Value) + 1) * 2);
        end;
        FramesList[Index].Stream.Seek(0, soBeginning);
        Result := True;
    except
...
begin
    ...
    try
        ...
        for i := 0 to List.Count - 1 do begin
            ...
            FramesList[Index].Stream.Write(Bytes[0], Length(Bytes));
            Data := $0;
            FramesList[Index].Stream.Write(Data, 1);
...
begin
    ...
    for i := 0 to ID3v2Tag.FrameCount - 1 do begin
        Index := AddFrame(ID3v2Tag.FramesList[i].ID);
        FramesList[Index].Assign(ID3v2Tag.FramesList[i]);
    end;
...
begin
    ...
    try
        ...
        OwnerIdentifier := FramesList[FrameIndex].Stream.ReadText;
        //* Get the content
        DataSize := FramesList[FrameIndex].Stream.Size - FramesList[FrameIndex].Stream.Position;
        if DataSize > 0 then begin
            SetLength(Result, DataSize);
...
begin
    ...
    try
        ...
        Encoding := FramesList[FrameIndex].Stream.ReadEncoding;
        //* Get price paid
        PricePaid := FramesList[FrameIndex].Stream.ReadText;
        ...
        //* Get seller
        Seller := FramesList[FrameIndex].Stream.ReadText(Encoding);
        FramesList[FrameIndex].Stream.Seek(0, soBeginning);
        Result := True;
    except
        //*
...
begin
    inherited;
    FramesList := TList<TID3v2Frame>.Create;
    //Unsynchronised := False;
end;
...
begin
    ...
    FramesList.Clear;
    FramesList.Capacity := ID3V2LIBRARY_FRAMES_GROWBY;
end;
