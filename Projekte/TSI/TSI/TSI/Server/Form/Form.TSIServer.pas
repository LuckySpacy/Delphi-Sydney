...
uses
  ...
  DBObj.SchnittstelleList, dbObj.AkStList, dbObj.AkSt, Objekt.Logger;
...
begin
  ...
  try
    ...
    MySqlBoersenindex.DBMYSqlTSI := dm.db;
...
begin
  ...
  try
    ...
    MySqlTSIAnsicht.DBMYSqlTSI := dm.db;
