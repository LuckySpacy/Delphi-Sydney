...
begin
  WriteIni(IniFilename, 'Datenbank', 'MySql_Server', Value);
end;

procedure TIni.setMySql_Server_DB(const Value: string);
begin
  WriteIni(IniFilename, 'Datenbank', 'MySql_Server_DB', Value);
end;

procedure TIni.setMySql_Server_Port(const Value: string);
begin
  WriteIni(IniFilename, 'Datenbank', 'MySql_Server_Port', Value);
end;

procedure TIni.setMySql_Server_PW(const Value: string);
begin
  WriteIni(IniFilename, 'Datenbank', 'MySql_Server_PW', Value);
end;

procedure TIni.setMySql_Server_User(const Value: string);
begin
  WriteIni(IniFilename, 'Datenbank', 'MySql_Server_User', Value);
end;
