...
type
  ...
  private
    ...
    fQry: TIBQuery;
    fQryMySqlS : TFDQuery;
    fQryMySqlSJHoch : TFDQuery;
    fQryMySqlSHJTief : TFDQuery;
    fQryMySqlKurs : TFDQuery;
    fQryMySqlI : TFDQuery;
    fQryMySqlU : TFDQuery;
...
uses
  DateUtils, Vcl.Forms, Objekt.Logger;
...
begin
  ...
  fQryMySqlSJHoch := TFDQuery.Create(nil);
  fQryMySqlSHJTief := TFDQuery.Create(nil);
  fQryMySqlKurs := TFDQuery.Create(nil);
...
begin
  ...
  //fQryMySqlU.SQL.Text := 'UPDATE tsiansicht SET TA_LetzterKurs=:letzterkurs, TA_TSI27=:tsi WHERE TA_ID = :taid';
  ...
  begin
    ...
    begin
      s := 'Wochen=' + IntToStr(aWochen) + ' / ak_id=' + fQry.FieldByName('tl_ak_id').AsString;
      Logger.Info(s);
    ...
    begin
      s := 'Wochen=' + IntToStr(aWochen) + ' / ak_id=' + fQry.FieldByName('tl_ak_id').AsString + ' / ta_id' + fQryMySqlS.FieldByName('ta_id').AsString;
      Logger.Info(s);
...
begin
  ...
  fQryMySqlS.Connection := fDBMySqlTSI;
  fQryMySqlU.Connection := fDBMySqlTSI;
  fQryMySqlSJHoch.Connection := fDBMySqlTSI;
  fQryMySqlSHJTief.Connection := fDBMySqlTSI;
  fQryMySqlKurs.Connection := fDBMySqlTSI;
