...
uses
  ...
  DBObj.Dateiformat in '..\..\..\DBObj\DBObj.Dateiformat.pas',
  DBObj.DateiformatList in '..\..\..\DBObj\DBObj.DateiformatList.pas',
  Form.Dateiformat in 'Form.Dateiformat.pas' {frm_Dateiformat};
