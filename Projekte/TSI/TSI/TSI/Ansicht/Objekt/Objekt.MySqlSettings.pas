...
begin
  Result := 'https://' + fIni.Host + 'TSI/aktie.php';
end;

function TMySqlSettings.getBoersenindexLink: string;
begin
  Result := 'https://' + fIni.Host + 'TSI/boersenindex.php';
end;

function TMySqlSettings.getKursLink: string;
begin
  Result := 'https://' + fIni.Host + 'TSI/kurs.php';
end;

function TMySqlSettings.getTSIAnsichtLink: string;
begin
  Result := 'https://' + fIni.Host + 'TSI/tsiansicht.php';
end;

function TMySqlSettings.getTSIWochenLink: string;
begin
  Result := 'https://' + fIni.Host + 'TSI/tsiwochen.php';
end;
