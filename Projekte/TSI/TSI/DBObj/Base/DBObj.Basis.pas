...
begin
  ...
  fFeldList.Add(getTablePrefix + '_' + 'Update', ftString);
  fFeldList.Add(getTablePrefix + '_' + 'Delete', ftString);
  fWasOpen := true;
  fUpdate := true;
  fDelete := false;
  fFeldList.FieldByName(getTablePrefix + '_' + 'Update').AsString := 'T';
  fFeldList.FieldByName(getTablePrefix + '_' + 'Delete').AsString := 'F';
end;
...
begin
  ...
  fFeldList.FieldByName(getTablePrefix + '_' + 'Update').AsString := aQuery.FieldByName(getTablePrefix + '_' + 'Update').AsString;
  fFeldList.FieldByName(getTablePrefix + '_' + 'Delete').AsString := aQuery.FieldByName(getTablePrefix + '_' + 'Delete').AsString;;
  fUpdate := aQuery.FieldByName(getTablePrefix + '_' + 'Update').AsString = 'T';
  fDelete := aQuery.FieldByName(getTablePrefix + '_' + 'Delete').AsString = 'T';
end;
