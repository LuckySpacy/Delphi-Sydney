unit Servermodul.TSISnapServerWeb;
...
uses Servermodul.TSISnapServerMethods, Web.WebReq;

procedure TWebModule1.DSServerClass1GetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := Servermodul.TSISnapServerMethods.TServerMethods1;
end;
...
begin
  if SameText(TagString, 'urlpath') then
    ...
    ReplaceText := Servermodul.TSISnapServerMethods.TServerMethods1.ClassName
