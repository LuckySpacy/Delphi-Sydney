...
begin
 ...
 if (not FileExists(ExtractFilePath(Application.ExeName) + 'log4dMyFileSaver.props')) then
   exit;

  TLogPropertyConfigurator.Configure(ExtractFilePath(Application.ExeName) + 'log4dMyFileSaver.props');
