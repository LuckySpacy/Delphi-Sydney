...
uses
  ...
  AdvObj, BaseGrid, AdvGrid, Vcl.ExtCtrls, Vcl.Menus, Vcl.AppEvnts,
  Objekt.Option, Objekt.OptionList, Objekt.Allgemein, Objekt.BackupChecker, Datenmodul.dm;
...
uses
  Form.Option, Objekt.Backup, Form.Mail, Vcl.Themes, System.UITypes;
...
procedure Tfrm_Zeitplaner.grdDblClickCell(Sender: TObject; ARow, ACol: Integer);
begin
...
procedure Tfrm_Zeitplaner.pop_CloseClick(Sender: TObject);
begin
  close;
end;

procedure Tfrm_Zeitplaner.pop_EMailEinstellungClick(Sender: TObject);
begin
  Show_EMail_Einstellung;
end;

procedure Tfrm_Zeitplaner.pop_ShowClick(Sender: TObject);
begin
  show;
...
procedure Tfrm_Zeitplaner.Show_EMail_Einstellung;
var
  Form: Tfrm_Mail;
begin
...
procedure Tfrm_Zeitplaner.StartBackup(aOption: TOption);
var
  Backup: TBackup;
begin
...
procedure Tfrm_Zeitplaner.Aktual(aReload: Boolean);
var
  i1: Integer;
  RowCount: Integer;
begin
...
procedure Tfrm_Zeitplaner.BackupEndet(Sender: TObject; aOption: TOption);
var
  i1: Integer;
begin
...
procedure Tfrm_Zeitplaner.BackupLauft(Sender: TObject; aOption: TOption);
var
  i1: Integer;
begin
  fBackupError := false;
...
procedure Tfrm_Zeitplaner.btn_LoeschenClick(Sender: TObject);
begin
...
procedure Tfrm_Zeitplaner.cbx_BackupManuellClick(Sender: TObject);
begin
  AllgemeinObj.Ini.ManuellesBackup := cbx_BackupManuell.Checked;
  fBackupChecker.TimerEnabled := not cbx_BackupManuell.Checked;
end;

procedure Tfrm_Zeitplaner.ErrorBackup(Sender: TObject; aOption: TOption;
  aError: string);
var
  i1: Integer;
begin
