...
begin
 ...
 if (not FileExists(ExtractFilePath(Application.ExeName) + 'log4dBugreportMail.props')) then
   exit;

  TLogPropertyConfigurator.Configure(ExtractFilePath(Application.ExeName) + 'log4dBugreportMail.props');
