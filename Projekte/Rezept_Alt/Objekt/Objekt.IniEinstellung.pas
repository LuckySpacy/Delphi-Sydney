...
begin
  ...
  try
    ...
    FIniPfad := IncludeTrailingPathDelimiter(Folderlocation.GetShellFolder) + 'Rezept\';
  finally
  ...
  FIniFileName     := FIniPfad + 'Rezept.ini';
  FIniGridFileName := FIniPfad + 'Rezept.ini';
  FIniConnect      := FIniPfad + 'Rezept_Connect.ini';
