...
function CGImageMetadataCreateMutable: CGMutableImageMetadataRef; cdecl; external libImageIO name _PU + 'CGImageMetadataCreateMutable';
...
function CGImageMetadataTagCreate(xmlns: CFStringRef; prefix: CFStringRef; name: CFStringRef; &type: CGImageMetadataType; value: CFTypeRef):
  CGImageMetadataTagRef; cdecl; external libImageIO name _PU + 'CGImageMetadataTagCreate';
...
function CGImageMetadataCopyTagWithPath(metadata: CGImageMetadataRef; parent: CGImageMetadataTagRef; path: CFStringRef): CGImageMetadataTagRef; cdecl;
  external libImageIO name _PU + 'CGImageMetadataCopyTagWithPath';
function CGImageMetadataCopyStringValueWithPath(metadata: CGImageMetadataRef; parent: CGImageMetadataTagRef; path: CFStringRef): CFStringRef; cdecl;
  external libImageIO name _PU + 'CGImageMetadataCopyStringValueWithPath';
function CGImageMetadataRegisterNamespaceForPrefix(metadata: CGMutableImageMetadataRef; xmlns: CFStringRef; prefix: CFStringRef; err: CFErrorRef):
  Integer; cdecl; external libImageIO name _PU + 'CGImageMetadataRegisterNamespaceForPrefix';
function CGImageMetadataSetTagWithPath(metadata: CGMutableImageMetadataRef; parent: CGImageMetadataTagRef; path: CFStringRef; tag:
  CGImageMetadataTagRef): Integer; cdecl; external libImageIO name _PU + 'CGImageMetadataSetTagWithPath';
function CGImageMetadataSetValueWithPath(metadata: CGMutableImageMetadataRef; parent: CGImageMetadataTagRef; path: CFStringRef; value: CFTypeRef):
  Integer; cdecl; external libImageIO name _PU + 'CGImageMetadataSetValueWithPath';
function CGImageMetadataRemoveTagWithPath(metadata: CGMutableImageMetadataRef; parent: CGImageMetadataTagRef; path: CFStringRef): Integer; cdecl;
  external libImageIO name _PU + 'CGImageMetadataRemoveTagWithPath';
procedure CGImageMetadataEnumerateTagsUsingBlock(metadata: CGImageMetadataRef; rootPath: CFStringRef; options: CFDictionaryRef; block:
  CGImageMetadataTagBlock); cdecl; external libImageIO name _PU + 'CGImageMetadataEnumerateTagsUsingBlock';
function CGImageMetadataCopyTagMatchingImageProperty(metadata: CGImageMetadataRef; dictionaryName: CFStringRef; propertyName: CFStringRef):
  CGImageMetadataTagRef; cdecl; external libImageIO name _PU + 'CGImageMetadataCopyTagMatchingImageProperty';
function CGImageMetadataSetValueMatchingImageProperty(metadata: CGMutableImageMetadataRef; dictionaryName: CFStringRef; propertyName: CFStringRef;
  value: CFTypeRef): Integer; cdecl; external libImageIO name _PU + 'CGImageMetadataSetValueMatchingImageProperty';
...
function CGImageSourceCreateWithDataProvider(provider: CGDataProviderRef; options: CFDictionaryRef): CGImageSourceRef; cdecl;
...
function CGImageSourceGetCount(isrc: CGImageSourceRef): size_t; cdecl; external libImageIO name _PU + 'CGImageSourceGetCount';
...
function CGImageSourceCopyPropertiesAtIndex(isrc: CGImageSourceRef; index: size_t; options: CFDictionaryRef): CFDictionaryRef; cdecl;
  external libImageIO name _PU + 'CGImageSourceCopyPropertiesAtIndex';
function CGImageSourceCopyMetadataAtIndex(isrc: CGImageSourceRef; index: size_t; options: CFDictionaryRef): CGImageMetadataRef; cdecl;
  external libImageIO name _PU + 'CGImageSourceCopyMetadataAtIndex';
function CGImageSourceCreateImageAtIndex(isrc: CGImageSourceRef; index: size_t; options: CFDictionaryRef): CGImageRef; cdecl;
...
function CGImageSourceCreateThumbnailAtIndex(isrc: CGImageSourceRef; index: size_t; options: CFDictionaryRef): CGImageRef; cdecl;
...
function CGImageDestinationCreateWithDataConsumer(consumer: CGDataConsumerRef; &type: CFStringRef; count: size_t; options: CFDictionaryRef):
  CGImageDestinationRef; cdecl; external libImageIO name _PU + 'CGImageDestinationCreateWithDataConsumer';
function CGImageDestinationCreateWithData(data: CFMutableDataRef; &type: CFStringRef; count: size_t; options: CFDictionaryRef): CGImageDestinationRef;
  cdecl; external libImageIO name _PU + 'CGImageDestinationCreateWithData';
function CGImageDestinationCreateWithURL(url: CFURLRef; &type: CFStringRef; count: size_t; options: CFDictionaryRef): CGImageDestinationRef; cdecl;
...
procedure CGImageDestinationAddImage(idst: CGImageDestinationRef; image: CGImageRef; properties: CFDictionaryRef); cdecl;
  external libImageIO name _PU + 'CGImageDestinationAddImage';
procedure CGImageDestinationAddImageFromSource(idst: CGImageDestinationRef; isrc: CGImageSourceRef; index: size_t; properties: CFDictionaryRef); cdecl;
...
function CGImageDestinationCopyImageSource(idst: CGImageDestinationRef; isrc: CGImageSourceRef; options: CFDictionaryRef; err: CFErrorRef): Integer;
