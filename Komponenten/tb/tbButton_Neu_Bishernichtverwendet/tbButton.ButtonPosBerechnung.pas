unit tbButton.ButtonPosBerechnung;
...
type
  TtbButtonButtonPosBerechnung = class
  private
    fBMP: TFlaeche;
    fCaption: string;
...
{ TtbButtonButtonPosBerechnung }


constructor TtbButtonButtonPosBerechnung.Create;
begin
  fCanvas := nil;
...
destructor TtbButtonButtonPosBerechnung.Destroy;
begin
  inherited;
...
procedure TtbButtonButtonPosBerechnung.Berechne;
var
  TextMass: TFlaeche;
