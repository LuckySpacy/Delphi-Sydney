unit tbButton.PropNotification;

interface

uses
  Classes, SysUtils, Contnrs, Controls, StdCtrls, ExtCtrls, Graphics, tbButton.PropPos,
  Winapi.Windows;
...
type
  TtbButtonPropNotification = class(TPersistent)
  private
  ...
  published
    ...
    property CirclePos: TtbButtonPropPos read fCirclePos write fCirclePos;
...
{ TtbButtonPropNotification }


constructor TtbButtonPropNotification.Create;
begin
  fCanvas := nil;
  ...
  fCirclePos := TtbButtonPropPos.Create;
  fCirclePos.OnChanged := PropPosChanged;
  fCircleColorTransparent := false;
end;

destructor TtbButtonPropNotification.Destroy;
begin
...
procedure TtbButtonPropNotification.PropPosChanged(Sender: TObject);
begin
  BerechneKreis;
end;

procedure TtbButtonPropNotification.setCaption(const Value: string);
begin
  fCaption := Value;
  BerechneKreis;
end;

procedure TtbButtonPropNotification.SetCircleAlignment(const Value: TImageAlignment);
begin
  fCircleAlignment := Value;
  BerechneKreis;
end;

procedure TtbButtonPropNotification.setCircleColor(const Value: TColor);
begin
  fCircleColor := Value;
  BerechneKreis;
end;

procedure TtbButtonPropNotification.setCircleColorTransparent(const Value: Boolean);
begin
  fCircleColorTransparent := Value;
  BerechneKreis;
end;

procedure TtbButtonPropNotification.setCircleFrameColor(const Value: TColor);
begin
  fCircleFrameColor := Value;
  BerechneKreis;
end;

procedure TtbButtonPropNotification.setCircleMarginX(const Value: Integer);
begin
  fCircleMarginX := Value;
  BerechneKreis;
end;

procedure TtbButtonPropNotification.setCircleMarginY(const Value: Integer);
begin
  fCircleMarginY := Value;
  BerechneKreis;
end;

procedure TtbButtonPropNotification.setFont(const Value: TFont);
begin
  fFont.Assign(Value);
  BerechneKreis;
end;

procedure TtbButtonPropNotification.setHeight(const Value: Integer);
begin
  fHeight := Value;
  BerechneKreis;
end;
...
procedure TtbButtonPropNotification.setPosX(const Value: Integer);
begin
  fPosX := Value;
end;

procedure TtbButtonPropNotification.setPosY(const Value: Integer);
begin
  fPosY := Value;
end;

procedure TtbButtonPropNotification.setWidth(const Value: Integer);
begin
  fWidth := Value;
  BerechneKreis;
end;
...
procedure TtbButtonPropNotification.BerechneKreis;
var
  TextPosMitte: TPoint;
  KreisPos1: TPoint;
  KreisPos2: TPoint;
...
procedure TtbButtonPropNotification.BerechneZifferKoord;
var
  KreisHalbe: TPoint;
  TextHalbe: TPoint;
begin
